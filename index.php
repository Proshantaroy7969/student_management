<?php
    if(isset($_POST['register'])){
        ...
        if(count($error)==0 ){
            ...
            $result =mysqli_query($con, "insert into class (name,roll,section,gender,result,email,address,phn) values('$name','$roll','$section','$gender','$result','$email','$address','$phn')"); 
...
<html>
    ...
    <body>
        ...
        <form action="" method="POST">
            ...
            ?><br>
            <input type="submit" name="register" value="Register info">
        </form>
    </body>
</html>